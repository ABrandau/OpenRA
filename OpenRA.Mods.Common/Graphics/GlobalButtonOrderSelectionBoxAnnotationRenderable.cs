...
namespace OpenRA.Mods.Common.Graphics
{
	public struct GlobalButtonOrderSelectionBoxAnnotationRenderable : IRenderable, IFinalizedRenderable
	{
		...
		{
			var tl = wr.Viewport.WorldToViewPx(new int2(decorationBounds.Left, decorationBounds.Top)).ToFloat2();
			var br = wr.Viewport.WorldToViewPx(new int2(decorationBounds.Right, decorationBounds.Bottom)).ToFloat2();
